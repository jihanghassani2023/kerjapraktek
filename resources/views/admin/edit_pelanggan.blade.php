...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-section">
            <form action="{{ route('admin.pelanggan.update', $pelanggan->id) }}" method="POST" id="editForm"
                novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control @error('nomor_telp') is-invalid @enderror" id="nomor_telp"
                        name="nomor_telp" value="{{ old('nomor_telp', $pelanggan->nomor_telp) }}" maxlength="13">
                    @error('nomor_telp')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    if (!phoneValue) {
                        ...
                        isValid = false;
                        showError(nomorTelpInput, telpError,
                            'Nomor telepon harus 8-13 digit dan hanya berisi angka.');
                        if (!firstErrorField) firstErrorField = nomorTelpInput;
                    }
