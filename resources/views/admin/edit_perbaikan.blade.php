                ...
                <div class="card-body">
                    <form action="{{ route('admin.perbaikan.update', $perbaikan->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_barang" name="nama_barang" class="form-control @error('nama_barang') is-invalid @enderror" value="{{ old('nama_barang', $perbaikan->nama_barang) }}" required>
                            @error('nama_barang')
