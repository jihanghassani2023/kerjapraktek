                    ...
                    <div class="statistics-container">
                        ...
                        <div class="stats-grid">
                            ...
                            <div class="stat-card">
                                ...
                                <div class="stat-card-value">{{ $perbaikanList->where('status', 'Selesai')->count() }}</div>
                            </div>
                            <div class="stat-card">
                                <div class="stat-card-title">Perbaikan Bulan Ini</div>
                                <div class="stat-card-value">{{ $perbaikanList->whereMonth('tanggal_perbaikan', date('m'))->count() }}</div>
                            </div>
                            <div class="stat-card">
                                <div class="stat-card-title">Total Pendapatan</div>
                                <div class="stat-card-value">Rp {{ number_format($perbaikanList->where('status', 'Selesai')->sum('harga'), 0, ',', '.') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-container">
                            ...
                            @else
                                <div class="empty-state">
                                    ...
                                    <p class="empty-state-text">Belum ada data perbaikan yang dilakukan oleh teknisi ini.</p>
                                </div>
                            @endif
                        </div>
                    </div>
